...
using PassIn.Api.Filters.CustomObjectResults;
...
namespace PassIn.Api.Filters
{
    public class ExceptionFilter : IExceptionFilter
    {
        ...
        private void HandleProjectException(ExceptionContext context)
        {
            ...
            else if (context.Exception is TooManyRegisterException)
            {
                context.HttpContext.Response.StatusCode = (int)HttpStatusCode.TooManyRequests;
                context.Result = new TooManyRequestsObjectResult(new ResponseErrorJson(context.Exception.Message));
            }
        }
